...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      <img src={assets.header_img} className='w-36 h-36 rounded-full mn-6'/>
      ...
      <button className='border border-gray-500 rounded-md px-8 py-2.5 hover:bg-gray-100 transition-all'>Get Started</button>
    </div>
  )
}
